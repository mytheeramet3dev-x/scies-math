//! Extended ODE solvers: stiff methods, high-order, multistep, symplectic, events.
//!
//! | Method | Type | Order | Stiff |
//! |---|---|---|---|
//! | `backward_euler` | Implicit, fixed step | 1 | ✅ |
//! | `crank_nicolson` | Implicit, fixed step | 2 | ✅ |
//! | `dopri8` | Explicit adaptive (DOP853) | 8(5) | — |
//! | `adams_bashforth4` | Explicit multistep | 4 | — |
//! | `adams_moulton4` | Predictor-corrector | 4 | — |
//! | `bdf2` | Implicit multistep | 2 | ✅ |
//! | `rosenbrock2` | Linearly implicit | ~2 | ✅ |
//! | `verlet` | Symplectic | 2 | — |
//! | `leapfrog` | Symplectic | 2 | — |
//! | `solve_with_events` | Event detection wrapper | — | — |
