...
Regression routines for linear, weighted, and regularized fitting.
...
- Include an intercept column explicitly when you want one.
- Use ridge regression when multicollinearity makes ordinary least squares unstable.
